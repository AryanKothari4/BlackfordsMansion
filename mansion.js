...
const slides = {
  "1": {
    story: "You wake up and are standing at the door of your room. Your mind is in a daze. You can’t remember why you’re standing there. Subconsciously, you feel that something is amiss. The only thing you remember about last night is falling asleep.<br><br>What do you do?",
    choices: [
  ...
  "2": {
    story: "You see a completely new, very royal looking hallway that is nothing like your house. It seems as if you are in a huge mansion. The walls stretch up for at least 30 feet, and the ground has a red carpet with gold linings. The walls are red and have big torches that light up the hallway. The hallway goes left and right.<br><br>What do you do?",
    choices: [
  ...
  "4": {
    story: "You see a lamp, no windows and something new in your room. You see a painting on the wall with a person depicted in it. Its eyes seem to be staring at the ceiling, and it also has a hand pointing towards a random wall.<br><br>What do you do?",
    choices: [
  ...
  "5": {
    story: "You start walking towards the end of the hallway and see some deep scratches on the wall. Whatever made them has a lot of strength.<br><br>What do you do?",
    choices: [
  ...
  "7": {
    story: "You grab the handle and try to twist it. It doesn’t budge. Noises start to come from the door. They sound like an animal. The door wraps itself around you and defeats you.",
    end: "YOU LOSE."
  },
  "8": {
  ...
  "11": {
    story: "You decide that it isn’t worth it. It looks as if some creature made those scratches. You walk back to the door of your bedroom.<br><br>What do you do?",
    choices: [
  ...
  "12": {
    story: "The road goes straight for a while and then turns left. You keep going and reach a strange, circular chamber that has an abyss in the middle. The only light in the room is the torches around you on the walls.<br><br>What do you do?",
    choices: [
  ...
  "13": {
    story: "You walk for a bit and find a fork. You can go left or straight. On the wall beside the path that goes straight, there is a painting. The painting is of two eyes in darkness peering at you with a gaze so disturbing it penetrates your soul. To the left is a very curvy and windy road. The feeling of beckoning was coming from there.<br><br>What do you do?",
    choices: [
  ...
  "19": {
    story: "The road continues straight for a while and then turns to the right. You keep following the road since you don’t have anywhere else to go. You arrive at a staircase and decide to go up it since there isn’t much that could go wrong. You reach what seems to be a grate above a dark room with a tiny bit of light. Surprisingly, there are no torches here. You see two eyes. Luckily, they aren't staring at you. It seems to be the Feared. The light source is a gem. There is a small opening to jump down into the room. It might be worth the risk.<br><br>What do you do?",
    choices: [
  ...
  "23": {
    story: "It responds with, \"It is a treasure so powerful that it lets you control the entire mansion. You can bend it according to your will. It is hidden behind a Feared.\"<br><br>What do you ask next?",
    choices: [
      { text: "\"How do I get out?\"", goto: "30" }
    ]
  },
  "24": {
    story: "You jump in and fall for at least 30 seconds and feel as if you've reached Mach 5. You see a tunnel that seems to lead nowhere but decide to follow it. At the end you see an animal or a creature, with the body of a bear and head of a tiger. It lunges at you and devours you.",
    end: "YOU LOSE."
  },
  "25": {
  ...
  "28": {
    story: "It responds with, \"I am a Feared. There are many around the mansion, and they are all meant to protect the Truseare.\"<br><br>What do you ask next?",
    choices: [
      { text: "\"How do I get out?\"", goto: "30" }
    ]
  },
  ...
  "30": {
    story: "It responds with, \"There are only 2 ways you can get out, but you must make sure to make the correct decisions. One mistake could be fatal. Go back down the other direction that you came from. Good luck,\" and with that, he disappeared back where he came from.<br><br>What do you do?",
    choices: [
